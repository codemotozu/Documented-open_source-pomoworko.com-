...
class TimeFramePopupMenuButton extends ConsumerStatefulWidget {
  final List<String> timeFrames;
  final String currentTimeFrame;
  final Function(String) onTimeFrameSelected;
  final bool isPremium;

  const TimeFramePopupMenuButton({
  ...
  ConsumerState<TimeFramePopupMenuButton> createState() =>
      _TimeFramePopupMenuButtonState();
}

class _TimeFramePopupMenuButtonState
    extends ConsumerState<TimeFramePopupMenuButton> {
